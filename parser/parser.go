...
func New(l *lexer.Lexer) *Parser {
	...
	// I do this to fill currToken and peekToken. [1,2,3,4] I think? Don't understand yet...
	p.nextToken() // curroken = nothing && peekToken = 1
	p.nextToken() // curToken = 1 && peekToken = 2
...
func (p *Parser) parseHashLiteral() ast.Expression {
	...
	// parse the key and parse the value
